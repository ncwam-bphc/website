...
export const reviews: Review[] = [
  { id: '1', paperId: '1', reviewerId: '1', status: 'accepted', comments: 'Good paper' },
  { id: '2', paperId: '1', reviewerId: '2', status: 'rejected', comments: 'Needs improvement' },
];
...
export function assignReviewers(paperId: string, reviewerIds: string[]) {
  ...
  console.log(`Assigning reviewers ${reviewerIds.join(', ')} to paper ${paperId}`);
}
